      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 grid-cols-1 items-center gap-10 px-6 py-12">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-3xl md:text-4xl  font-bold leading-tight text-gray-800">
            Shop the Latest Trends at <span className="text-red-500">Atlantis View!</span>
          </h1>

          <p className="text-gray-600 md:w-4/5">
            Discover your fashion style, dive into fashion’s depth, and make a splash with Atlantis view – where the latest trends flow every day!
          </p>
